...
def update_bar_chart(site_dropdown, payload_slider):
    ...
    if site_dropdown == 'ALL':
        ...
        fig = px.scatter(
            ...
            color="Booster Version Category", title='Corelation between Payload and Success for all sites')
    else:
        ...
        fig = px.scatter(
            filtered_df, x="Payload Mass (kg)", y="class", 
            color="Booster Version Category", title='Corelation between Payload and Success for site '+ site_dropdown)
    return fig
